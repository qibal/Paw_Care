...
namespace PawCare.Model
{
    public class M_Animal
    {
        ...
        public M_Animal(string animal_id, string animal_name, string gender, int age, string image_path, string category_id, DateTime created_at, DateTime updated_at)
        {
